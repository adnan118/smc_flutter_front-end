    ...
    return SingleChildScrollView(
      ...
      Neumorphic(
        child: Container(
         ...
         ? Text("notesubuserCoach".tr,style: Theme.of(context).textTheme.displaySmall!.copyWith(color: ColorApp.lightBlack.withOpacity(0.5)),):Text(""),
      controller.dataSelectUser.isEmpty
          ? ListView.builder(
              shrinkWrap: true,
              physics: BouncingScrollPhysics(),
              itemCount: controller.dataAllTrainees.length,
                  ...
                  child: Row(
                    ...
                    children: [
                      AvatarImag(
                        ...
                        img:
                            "${ImageAssetApp.ImageProfile}/${controller.dataAllTrainees[index]!.usersImage}",
                        radius: 25.0,
                        numCircle: 1,
                      ),
                      SizedBox(
                      ...
                      Column(
                        children: [
                          Text(
                            "${controller.dataAllTrainees[index]!.usersFullName}",
                          ...
                          Text(
                            "ID_${controller.dataAllTrainees[index]!.usersId} ",
                            style: Theme.of(context)
                                .textTheme
                                .displaySmall!
                                .copyWith(
                      ...
                      IconButton(onPressed: (){
                        controller.deleteSelectUserfromcoach(controller.dataAllTrainees[index]!.usersId);
                      }, icon: Icon(Icons.highlight_remove))
                    ],
                  ),
                  onPressed: () {
                    controller.getDataProfileSelectUser(
                        controller.dataAllTrainees[index]!.usersId.toString());
                  },
                );
              })
          :
